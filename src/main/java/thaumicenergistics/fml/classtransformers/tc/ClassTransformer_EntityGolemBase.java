...
public class ClassTransformer_EntityGolemBase extends AClassTransformer {
    ...
    private void insertMethod_GolemBase_onEntityUpdate(final ClassNode classNode, final boolean isObf) {
        ...
        onEntityUpdate.instructions.add(new MethodInsnNode(
                Opcodes.INVOKESPECIAL, "net/minecraft/entity/monster/EntityGolem", oEU_Name, "()V", false));
    ...
    private void transformMethod_EntityInit(final MethodNode method) {
        ...
        // new HashMap
        instructionList.add(
                new TypeInsnNode(Opcodes.NEW, GolemHookTransformHelper.FIELDTYPE_EntityGolemBase_hookHandlers));
