...
public class PacketServerConfirmCraftingJob
	extends AbstractServerPacket
{
	...
	public PacketServerConfirmCraftingJob createRequestConfirmAutoCraft( final EntityPlayer player, final long amount, final boolean isShiftHeld )
	{
		// Set the player
		this.player = player;

		// Set the mode
		this.mode = PacketServerConfirmCraftingJob.MODE_REQUEST_CONFIRM;

		// Set amount
		this.amount = amount;

		// Set shift
		this.heldShift = isShiftHeld;
