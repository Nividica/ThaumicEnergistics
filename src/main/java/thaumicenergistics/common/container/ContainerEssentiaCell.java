...
public class ContainerEssentiaCell extends ContainerEssentiaCellTerminalBase {
    ...
    public void onClientRequestFullUpdate() {
        ...
        if (cellHandler != null) {
            ...
            Packet_C_EssentiaCellTerminal.sendViewingModes(
                    this.player, cellHandler.getSortingMode(), cellHandler.getViewMode());
        }
    ...
    public void onClientRequestViewModeChange(final EntityPlayer player, final boolean backwards) {
        ...
        if (cellHandler != null) {
            ...
            ViewItems viewMode =
                    Platform.rotateEnum(cellHandler.getViewMode(), backwards, Settings.VIEW_MODE.getPossibleValues());
