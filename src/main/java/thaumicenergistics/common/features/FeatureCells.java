...
public class FeatureCells extends ThEThaumcraftResearchFeature {
     ...
     * @param group
     */
    private void replaceRecipeIngredientWithGroup(
            final ShapedArcaneRecipe recipe, final ItemStack ingredient, final ArrayList<ItemStack> group) {
        // Get the input
    ...
    protected Object[] getItemReqs(final CommonDependantItems cdi) {
        return new Object[] {
            cdi.ChargedCertusQuartz,
            cdi.CertusQuartz,
            cdi.PureCertusQuartz,
            cdi.LogicProcessor,
    ...
    protected void registerCrafting(final CommonDependantItems cdi) {
        ...
        ItemStack EssentiaCellWorkbench =
                ThEApi.instance().blocks().EssentiaCellWorkbench.getStack();
        ...
        // Housing recipe
        Object[] recipeHousing =
                new Object[] {"WRW", "R R", "TTT", 'W', cdi.WardedGlass, 'R', cdi.RedstoneDust, 'T', cdi.ThaumiumIngot};
        ...
        // 1K Storage recipe
        Object[] recipe1KStorage = new Object[] {
            "EQ ", "QPQ", " QE", 'E', cdi.EtheralEssence, 'Q', cdi.CertusQuartz, 'P', cdi.LogicProcessor
        };

        // 1K Cell recipe
        Object[] recipe1KCell = new Object[] {
            "WRW",
            "RCR",
            "TTT",
            'W',
        ...
        RecipeRegistry.ITEM_STORAGE_COMPONENT_1K = ThaumcraftApi.addArcaneCraftingRecipe(
                this.researchKey, EssentiaStorageComponent_1k, aspects1KStorage, recipe1KStorage);
        ...
        GameRegistry.addRecipe(
                RecipeRegistry.ITEM_STORAGE_CELL_1K_SHAPELESS =
                        new ShapelessOreRecipe(EssentiaCell_1k, EssentiaStorageComponent_1k, EssentiaCell_Housing));
        ...
        this.replaceRecipeIngredientWithGroup(
                (ShapedArcaneRecipe) RecipeRegistry.ITEM_STORAGE_COMPONENT_1K, cdi.CertusQuartz, GroupQuartz);
        ...
        // 4K Storage recipe
        Object[] recipe4KStorage = new Object[] {
            "EPE",
            "1G1",
            "E1E",
            'E',
        ...
        // 4K Cell recipe
        Object[] recipe4KCell = new Object[] {
            "WRW",
            "RCR",
            "TTT",
            'W',
        ...
        RecipeRegistry.ITEM_STORAGE_COMPONENT_4K = ThaumcraftApi.addArcaneCraftingRecipe(
                this.researchKey, EssentiaStorageComponent_4k, aspects4KStorage, recipe4KStorage);
        ...
        GameRegistry.addRecipe(
                RecipeRegistry.ITEM_STORAGE_CELL_4K_SHAPELESS =
                        new ShapelessOreRecipe(EssentiaCell_4k, EssentiaStorageComponent_4k, EssentiaCell_Housing));
        ...
        // 16K Storage recipe
        Object[] recipe16KStorage = new Object[] {
            "SPE",
            "4G4",
            "E4S",
            'E',
        ...
        // 16K Cell recipe
        Object[] recipe16KCell = new Object[] {
            "WRW",
            "RCR",
            "TTT",
            'W',
        ...
        RecipeRegistry.ITEM_STORAGE_COMPONENT_16K = ThaumcraftApi.addArcaneCraftingRecipe(
                this.researchKey, EssentiaStorageComponent_16k, aspects16KStorage, recipe16KStorage);

        // Register 16K cell
        GameRegistry.addRecipe(
                RecipeRegistry.ITEM_STORAGE_CELL_16K_SHAPED =
                        new ShapedOreRecipe(EssentiaCell_16k, false, recipe16KCell));
        GameRegistry.addRecipe(
                RecipeRegistry.ITEM_STORAGE_CELL_16K_SHAPELESS =
                        new ShapelessOreRecipe(EssentiaCell_16k, EssentiaStorageComponent_16k, EssentiaCell_Housing));
        ...
        // 64K Storage recipe
        Object[] recipe64KStorage = new Object[] {
            "SPS",
            "6G6",
            "S6S",
            'S',
        ...
        // 64K Cell recipe
        Object[] recipe64KCell = new Object[] {
            "WRW",
            "RCR",
            "TTT",
            'W',
        ...
        RecipeRegistry.ITEM_STORAGE_COMPONENT_64K = ThaumcraftApi.addArcaneCraftingRecipe(
                this.researchKey, EssentiaStorageComponent_64k, aspects64KStorage, recipe64KStorage);

        // 64K Storage Cell
        GameRegistry.addRecipe(
                RecipeRegistry.ITEM_STORAGE_CELL_64K_SHAPED =
                        new ShapedOreRecipe(EssentiaCell_64k, false, recipe64KCell));
        GameRegistry.addRecipe(
                RecipeRegistry.ITEM_STORAGE_CELL_64K_SHAPELESS =
                        new ShapelessOreRecipe(EssentiaCell_64k, EssentiaStorageComponent_64k, EssentiaCell_Housing));
    ...
    protected void registerResearch() {
        ...
        IArcaneRecipe[] storageComponentRecipes = new IArcaneRecipe[] {
        ...
        IRecipe[] storageCellsShaped = new IRecipe[] {
        ...
        IRecipe[] storageCellsShapeless = new IRecipe[] {
            RecipeRegistry.ITEM_STORAGE_CELL_1K_SHAPELESS,
            RecipeRegistry.ITEM_STORAGE_CELL_4K_SHAPELESS,
            RecipeRegistry.ITEM_STORAGE_CELL_16K_SHAPELESS,
            RecipeRegistry.ITEM_STORAGE_CELL_64K_SHAPELESS
