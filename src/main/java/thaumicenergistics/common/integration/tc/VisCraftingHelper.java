...
public class VisCraftingHelper {
    ...
    public ItemStack getCraftingScepter() {
        if (this.craftingScepter == null) {
            ...
            ((ItemWandCasting) this.craftingScepter.getItem())
                    .setCap(this.craftingScepter, ConfigItems.WAND_CAP_THAUMIUM);

            // Set cap type to silverwood
            ((ItemWandCasting) this.craftingScepter.getItem())
                    .setRod(this.craftingScepter, ConfigItems.WAND_ROD_SILVERWOOD);
    ...
    public float getScepterVisModifier(final Aspect aspect) {
        ...
        return ((ItemWandCasting) this.craftingScepter.getItem())
                .getConsumptionModifier(this.craftingScepter, null, aspect, true);
    }
}
