...
public interface IThETransportPermissions
{
	 ...
	 */
	<T extends TileEntity & IAspectContainer> boolean addAspectContainerTileToBothPermissions( @Nonnull Class<T> tileClass, int capacity );
	 ...
	 */
	<T extends TileEntity & IAspectContainer> boolean addAspectContainerTileToExtractPermissions( @Nonnull Class<T> tileClass, int capacity );
	 ...
	 */
	<T extends TileEntity & IAspectContainer> boolean addAspectContainerTileToInjectPermissions( @Nonnull Class<T> tileClass, int capacity );
	 ...
	 * @param canHoldPartialAmount
	 */
	void addEssentiaContainerItemToTransportPermissions( @Nonnull ItemStack containerItem, int capacity, boolean canHoldPartialAmount );
